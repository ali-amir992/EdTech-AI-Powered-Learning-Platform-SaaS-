...
import { CourseChatbot } from "@/components/courseDetails/CourseChatBot"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="container mx-auto pl-6 md:pl-12 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="md:col-span-1">{course ? <StickyCourseCard course={course} /> : null}</div>
        </div>
      </section>

      {/* Course Chatbot */}
      {course && <CourseChatbot courseTitle={course.title}  />}
    </div>
  )
}
